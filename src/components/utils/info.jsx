...
const Info = ({ c1, c2, c3, h }) => {
  return (
    <div className={`w-[95%] lg:w-[80%] px-5 flex-col gap-5 ${h && 'hidden'}`}>
      <div className={`bsp ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
        <span>Base Price</span>
        <h2 className='text-xl font-semibold'>{c1?.prc || c2?.prc || c3?.prc}</h2>
      </div>
      <div className={`rng ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
        <span>Range</span>
      ...
      <div className={`stg ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
        <span>
      ...
      <div className={`crg ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
      ...
      <div className={`drv ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
        <span>Drive</span>
        <h2 className='text-xl font-semibold'>
      ...
      <div className={`acc ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
      ...
      <div className={`spd ${c1 ? 'comp1' : c2 ? 'comp2' : c3 && 'comp3'} flex-col`}>
        <span>
